...
columns = ['price', 'region', 'street_name', 'room_count', 'square', 'floor', 'subway']
...
for i, flat in zip(range(len(data['flats'])), data['flats']):
    ...
    sheet.write(i+1, 2, flat['street_name'])
    sheet.write(i+1, 3, flat['room_count'])
    sheet.write(i+1, 4, flat['square'])
    sheet.write(i+1, 5, flat['floor'])
    sheet.write(i+1, 6, flat['subway'])
